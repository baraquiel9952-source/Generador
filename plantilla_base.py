...
class ConstanciaFiscalBase(FPDF):
    ...
    def _pagina_1(self):
        ...
        dom_izq = [
            ...
            (172, 2463, 'Número Interior:', 'numero_interior', 397),
            (172, 2551, 'Nombre de la Localidad:', 'localidad', 490),
            (172, 2637, 'Nombre de la Entidad Federativa:', 'estado', 490),
        ...
        dom_der = [
            ...
            (1247, 2463, 'Nombre de la Colonia:', 'colonia', 1587),
            (1247, 2532, 'Nombre del Municipio o Demarcación Territorial:', 'municipio', 1247),
